...
namespace Main
{
    public partial class UI_SelectVenueCont : GComponent
    {
        ...
        public static UI_SelectVenueCont CreateInstance()
        {
            return (UI_SelectVenueCont)UIPackage.CreateObject("Main", "SelectVenueCont");
        }
