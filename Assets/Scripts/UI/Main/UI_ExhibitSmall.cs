...
namespace Main
{
    public partial class UI_ExhibitSmall : GComponent
    {
        ...
        public static UI_ExhibitSmall CreateInstance()
        {
            return (UI_ExhibitSmall)UIPackage.CreateObject("Main", "ExhibitSmall");
        }
