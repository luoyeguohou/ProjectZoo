...
namespace Main
{
    public partial class UI_PutExhibitCont : GComponent
    {
        ...
        public static UI_PutExhibitCont CreateInstance()
        {
            return (UI_PutExhibitCont)UIPackage.CreateObject("Main", "PutExhibitCont");
        }
